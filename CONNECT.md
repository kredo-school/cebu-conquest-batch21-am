...
> **ZeroTier Network IP of the Host:** `10.20.60.114`
...
```
[Team Members]
  Browser → ZeroTier (10.20.60.114) → [Windows Host Machine]
...
3. Confirm your **ZeroTier IP is `10.20.60.114`**. You can verify this by running `ipconfig` in Command Prompt and looking for the ZeroTier adapter.
...
```
VITE_API_BASE_URL=http://10.20.60.114/cebu-conquest-batch21-am/public/api
VITE_SOCKET_URL=http://10.20.60.114:3001
```
...
```
  ...
  Network: http://10.20.60.114:5173/    ← Share this URL with the team!
```

### Step 7: Share the URL
Tell all team members to open their browsers and go to:

**👉 `http://10.20.60.114:5173`**
...
| Problem | Solution |
|---|---|
| Cannot reach `http://10.20.60.114:5173` | Make sure ZeroTier is connected and status is **Online** |
