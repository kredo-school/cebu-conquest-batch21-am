...
export const LoginView: React.FC<LoginViewProps> = ({ onLogin, onOpenSettings, onOpenHelp }) => {
  ...
  return (
    // 🚀 修正：h-screenを無くし、w-full h-full に統一
    <div className="w-full h-full bg-slate-950 font-body text-slate-200 overflow-hidden flex flex-col relative">
      ...
      <main className="relative z-20 flex-1 flex flex-col items-center justify-center px-4 pt-16 pb-4 text-center">
        ...
        <div className="mb-6">
          {/* 🚀 修正：font-fixを追加 */}
          <div className="inline-block px-3 py-0.5 rounded-full border border-orange-500/30 bg-orange-500/10 text-orange-400 text-[10px] font-bold tracking-[0.2em] mb-2 uppercase font-fix">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-3 w-full max-w-3xl">
          <div className="bg-slate-900/40 backdrop-blur-sm p-3 rounded-xl border border-slate-800/50 flex items-center gap-3 text-left">
            ...
            <div>
              <div className="text-white font-bold text-sm font-fix">No Laravel</div>
              <div className="text-slate-500 text-[10px] font-fix">Pure Native PHP Project.</div>
            </div>
          </div>
          <div className="bg-slate-900/40 backdrop-blur-sm p-3 rounded-xl border border-slate-800/50 flex items-center gap-3 text-left">
            ...
            <div>
              <div className="text-white font-bold text-sm font-fix">God Teachers</div>
              <div className="text-slate-500 text-[10px] font-fix">Unbelievable Mentorship.</div>
            </div>
          </div>
          <div className="bg-slate-900/40 backdrop-blur-sm p-3 rounded-xl border border-slate-800/50 flex items-center gap-3 text-left">
            ...
            <div>
              <div className="text-white font-bold text-sm font-fix">Island Lore</div>
              <div className="text-slate-500 text-[10px] font-fix">Cebu Conquest Lore.</div>
            </div>
          </div>
        </div>
      </main>
