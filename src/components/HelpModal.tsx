    ...
    <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4 md:p-8 animate-fadeIn">
      ...
      <div className="relative w-full max-w-4xl bg-slate-900 border border-cyan-500/30 rounded-2xl shadow-[0_0_50px_rgba(6,182,212,0.2)] overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 border-b border-cyan-500/20 bg-cyan-500/5 flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-black text-cyan-400 italic tracking-tighter uppercase">Tactical Manual</h2>
            <p className="text-[10px] text-cyan-700 font-bold tracking-[0.3em] uppercase">Operation: Cebu Conquest</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar space-y-12">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-black text-white uppercase tracking-widest">01. 勝利条件</h3>
            </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-black text-white uppercase tracking-widest">02. リソース管理</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-11">
              <div className="bg-slate-800/50 p-4 rounded-xl border border-white/5">
                <span className="text-cyan-400 font-black text-[10px] uppercase block mb-1">AP (Action Points)</span>
                <p className="text-slate-300 text-xs">移動、攻撃、占拠などの行動に必要です。毎ターン一定量回復します。</p>
              </div>
              <div className="bg-slate-800/50 p-4 rounded-xl border border-white/5">
                <span className="text-orange-400 font-black text-[10px] uppercase block mb-1">Armor (HP)</span>
                <p className="text-slate-300 text-xs">ユニットの耐久値です。0になると戦線離脱となり、拠点を失うリスクが生じます。</p>
              </div>
            </div>
          </section>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-black text-white uppercase tracking-widest">03. 守護神の加護</h3>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed pl-11 mb-4">
              出撃前に選択する守護神によって、特殊なバフが付与されます。
            </p>
            <ul className="grid grid-cols-2 gap-2 pl-11 text-[11px] text-slate-500 font-bold uppercase italic">
              <li>• Lapu-Lapu: 攻撃力強化</li>
              <li>• Sebuna: 最大AP増加</li>
              <li>• Kredo: AP回復速度UP</li>
              <li>• Bakunawa: 夜間ステルス</li>
            </ul>
          </section>
        ...
        <div className="p-4 bg-slate-950/50 border-t border-cyan-500/10 text-center">
          <p className="text-[9px] text-cyan-900 font-black tracking-[0.5em] uppercase">System: Manual v1.0.4 - Operational</p>
        </div>
      </div>
    </div>
  );
