...
// 🚀 島ID定数（GDD v3.0準拠 [cite: 70, 75, 77, 79, 81]）
...
/**
 * 🛰️ ActionPanel: プレイヤーの戦術アクションを管理
 * 仕様: 拠点選択が完了するまで「START MISSION」を維持する
 */
export const ActionPanel: React.FC = memo(() => {
  ...
  // 🚀 ポイント：現在のプレイヤーデータから「既に配置済みか」を確認 [cite: 61]
  ...
  // 1. 【出撃フェーズ】 ターン0、または自分の位置が未確定の場合 [cite: 22]
  ...
  // 3. 【自分のターン：メインアクション】 [cite: 27, 59, 106]
